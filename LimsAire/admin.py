...
# from .models import  Parametros,UnidadDeMedicion,FactorDeConversion,CadenaDeCustodia,AsignacionesDeParametros,Mediciones
...
# admin.site.register(AsignacionesDeParametros)
